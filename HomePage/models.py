...
class Footer_other_detail_header(models.Model):
    ...
    class Meta:
         verbose_name = 'Footer Other Detail Title'
         verbose_name_plural = 'Footer Other Detail Title'
...
class Header_li(models.Model):
    ...
    List_Data = models.CharField(max_length=300, blank=True, null= True)
    
    class Meta:
         verbose_name = 'Footer Other Detail Title Data'
         verbose_name_plural = 'Footer Other Detail Title Data'
    
    

    
class Payment_Merchant(models.Model):
    Payment_image =models.ImageField(upload_to='HomePage/media/', blank=True, null=True)
    
    class Meta:
         verbose_name = 'Payment Merchent Image'
         verbose_name_plural = 'Payment Merchent Image'
...
class Footer_Last_section(models.Model):
    ...
    class Meta:
         verbose_name = 'Footer warning site'
         verbose_name_plural = 'Footer warning site'
