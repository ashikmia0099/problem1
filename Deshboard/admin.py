...
from .models import BannerModel,All_category_text,All_Category_model,All_Category_Card_Data,HomeOurService, Our_Service_Text,HomeInstituteBanner,HomeInstituteBannersecond,HomeEvent,HomeExpertTeacher,HomeStudentOpenion,our_partner
