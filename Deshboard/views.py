...
from . models import BannerModel, All_category_text,All_Category_model,All_Category_Card_Data,HomeOurService,Our_Service_Text
...
def HomeView(request, category_slug = None):
    ...
    # 2. Banner Model ses
    First_banner = BannerModel.objects.all()
    
    # 2.1. Banner Model 
    last_banner = BannerModel.objects.last()
    
    video_url = last_banner.Banner_video if last_banner else None
    ...
    last_uploaded_service = HomeOurService.objects.last()
    # 5.1 Our Special Service
    ourSercicesec = Our_Service_Text.objects.all()
    ...
    return render(request, 'home.html',{
        ...
        'last_uploaded_service':last_uploaded_service,
        'ourSercicesec':ourSercicesec,
