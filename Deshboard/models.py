...
class BannerModel(models.Model):
    ...
    Banner_video = EmbedVideoField(blank=True, null=True, default=' ')
...
class HomeOurService(models.Model):
    ...
    SercicebannerImage =models.ImageField(upload_to='Deshboard/media/', blank=True, null=True, default=' ')
    Sercicebannervideo =models.FileField(upload_to='Deshboard/media/video', blank=True, null=True, default= ' ')
...
class Our_Service_Text(models.Model):
    ...
    class Meta:
         verbose_name = '5. Our Service Heading Text '
         verbose_name_plural = '5. Our Service Heading Text '
