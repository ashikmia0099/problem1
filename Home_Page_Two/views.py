...
def CourseDetailsPage(request,id):
    ...
    CourseTitle = Course_Title.objects.filter(chooes_Course=chooes_Category)
    ...
    return render(request,'course_detailpage.html', {'Home_Page_Two':card,'CourseTitle': CourseTitle, 'grouped_data':grouped_data,'HeaderName':HeaderName,'purposeCourse':purposeCourse, 'Image':Image, 'StudentOpenion':StudentOpenion,'studentQuestion':studentQuestion, 'learningTopic':learningTopic, 'TeacherAbout':TeacherAbout,  'module_data': module_data})    
